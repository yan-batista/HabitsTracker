...
const HabitDay = ({ date, amountOfHabits = 0, amountCompleted = 0, ...rest }: Props) => {
  ...
  return (
    <TouchableOpacity
      className={clsx("rounded-lg border-2 m-1", {
        ["bg-zinc-900 border-800"]: amountAccomplishedPercentage === 0,
        ...
        ["bg-violet-700 border-violet-500"]: amountAccomplishedPercentage > 50 && amountAccomplishedPercentage < 60,
